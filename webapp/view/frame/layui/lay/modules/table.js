...
function(e) {
    ...
    A.prototype.pullData = function(e, i) {
        ...
        if (n.url) {
            ...
            var $url, $data;
            if(n.method == 'post'){
                $url = n.url + '?' + o.pageName + '=' + e + '&' + o.limitName + '=' + n.limit;
                //$url = n.url;
                $data = JSON.stringify(n.where);
            }else{
                $url = n.url;
            ...
            t.ajax({
                ...
                data: $data,
                success: function(t) {
                    //edit by terry 2017/10/11
                    var cArr = r.countName.split('.'),
                    cLen = cArr.length,
                    cc;
                    ...
                    if(cLen == 1){
                        ...
                        cc = t[cArr[0]][cArr[1]][cArr[2]];
                    }else if(cLen == 4){
                        cc = t[cArr[0]][cArr[1]][cArr[2]][cArr[3]];
                    }
                    
                    return t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="layui-none">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, cc), d(), i && l.close(i), void("function" == typeof n.done && n.done(t, e, cc)))
                },
                error: function(e, t) {
    ...
    A.prototype.renderData = function(e, n, o, r) {
        ...
        var cc;
        if(r != true){
            var cArr = this.config.response.dataName.split('.'),
            cLen = cArr.length;
            ...
            if(cLen == 1){
                ...
                cc = e[cArr[0]][cArr[1]][cArr[2]];
            }else if(cLen == 4){
                cc = e[cArr[0]][cArr[1]][cArr[2]][cArr[3]];
            }
        }else{
            cc = e.data;
        }
        ...
        d.cache[c.key] = u,
        r ? p() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.html('<div class="layui-none">无数据</div>')) : (p(), void(s.page && (c.page = n, c.count = o, a.render({
    ...
    A.prototype.sort = function(e, i, a, n) {
        ...
        "asc" === i ? c = layui.sort(y, r) : "desc" === i ? c = layui.sort(y, r, !0) : (c = layui.sort(y, d.config.indexName), delete u.sortKey),
        u.renderData({
            data: c
        },
        u.page, u.count, !0),
    ...
    A.prototype.events = function() {
        ...
        function() {
            ...
            m = a.layBody.find('.sub-tr'),
            n = e[0].checked,
            o = "layTableAllChoose" === e.attr("lay-filter");

            //全选订单时关闭运单 edit by terryzhong 2017/11/8
            if(o){
                k = t(this).attr('class').indexOf('layui-form-checked');
                if(k > -1 && m.length > 0){
                    m.remove();
                    a.layBody.find('.fold').text('+');
                }
            }
